...
Clazz.load (["J.adapter.smarter.AtomSetCollectionReader"], "J.adapter.readers.xtal.VaspChgcarReader", null, function () {
...
this.rd ();
for (var i = 0; i < atomCounts.length; i++) for (var j = atomCounts[i]; --j >= 0; ) this.addAtomXYZSymName (J.adapter.smarter.AtomSetCollectionReader.getTokensStr (this.rd ()), 0, (atomSym == null ? "Xx" : atomSym[i]), null);
